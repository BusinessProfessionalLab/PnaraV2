        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersonnelCode = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpeningCash = table.Column<decimal>(type: "decimal(18,0)", nullable: false),
                    ClosingCash = table.Column<decimal>(type: "decimal(18,0)", nullable: true),
                    ExpectedCash = table.Column<decimal>(type: "decimal(18,0)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReorderPoint = table.Column<decimal>(type: "decimal(18,3)", nullable: false),
                    SafetyStock = table.Column<decimal>(type: "decimal(18,3)", nullable: false),
                    ...
                    AverageCost = table.Column<decimal>(type: "decimal(18,0)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisplayNameFa = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ComPort = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxIdentificationNumber = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
                    ...
                    VatRate = table.Column<decimal>(type: "decimal(9,6)", nullable: false),
                    CurrencyCode = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: false),
                    LoyaltyPointsPerMillionRial = table.Column<int>(type: "int", nullable: false),
                    ThermalPrinterHost = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    ThermalPrinterPort = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TableNumber = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: true),
                    CustomerPhone = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: true),
                    ...
                    ModifiersTotal = table.Column<decimal>(type: "decimal(18,0)", nullable: false),
                    ...
                    GrandTotal = table.Column<decimal>(type: "decimal(18,0)", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxInclusive = table.Column<bool>(type: "bit", nullable: false),
                    LineSubtotal = table.Column<decimal>(type: "decimal(18,0)", nullable: false),
                    LineModifiersTotal = table.Column<decimal>(type: "decimal(18,0)", nullable: false),
                    LineTotal = table.Column<decimal>(type: "decimal(18,0)", nullable: false),
                    TicketStation = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TraceNumber = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ReferenceNumber = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    Rrn = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ...
                    CardMask = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
                    PaidAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Payments_PosDevices_PosDeviceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MenuItemModifierId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recipes_MenuItemModifiers_MenuItemModifierId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MenuItemModifierId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    ExtraPrice = table.Column<decimal>(type: "decimal(18,0)", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    TicketStation = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecipeLines_InventoryItems_InventoryItemId",
                        column: x => x.InventoryItemId,
                        principalTable: "InventoryItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_EntityName_OccurredAt",
                table: "AuditLogs",
                columns: new[] { "EntityName", "OccurredAt" });

            migrationBuilder.CreateIndex(
                name: "IX_CashierShifts_IsDeleted",
                table: "CashierShifts",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_CashierShifts_StaffId_Status",
                table: "CashierShifts",
                columns: new[] { "StaffId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Categories_DisplayPriority",
                table: "Categories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItemModifiers_IsDeleted",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItems_CategoryId_DisplayPriority",
                table: "MenuItems",
                columns: new[] { "CategoryId", "DisplayPriority" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_PosDeviceId",
                table: "Payments",
                column: "PosDeviceId");

            migrationBuilder.CreateIndex(
                name: "IX_Payments_TraceNumber",
                table: "Payments",
                column: "TraceNumber");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PosDevices_IsDeleted",
                table: "PosDevices",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_RecipeLines_InventoryItemId",
                table: "RecipeLines",
                column: "InventoryItemId");

            migrationBuilder.CreateIndex(
                name: "IX_RecipeLines_RecipeId_InventoryItemId",
                table: "RecipeLines",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recipes_MenuItemModifierId",
                table: "Recipes",
                column: "MenuItemModifierId",
                unique: true,
                filter: "[MenuItemModifierId] IS NOT NULL");
