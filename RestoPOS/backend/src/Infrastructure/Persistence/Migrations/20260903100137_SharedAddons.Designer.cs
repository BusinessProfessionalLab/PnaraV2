...
namespace RestoPOS.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260903100137_SharedAddons")]
    partial class SharedAddons
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestoPOS.Domain.Entities.Addon", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RestoPOS.Domain.Entities.MenuItemAddon", b =>
                {
                    b.HasOne("RestoPOS.Domain.Entities.Addon", "Addon")
                        .WithMany("MenuItems")
            ...
            modelBuilder.Entity("RestoPOS.Domain.Entities.Recipe", b =>
                {
                    b.HasOne("RestoPOS.Domain.Entities.Addon", "Addon")
                        .WithOne("Recipe")
                        .HasForeignKey("RestoPOS.Domain.Entities.Recipe", "AddonId");
